...
define SHADOW_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 -D $(@D)/src/chfn $(TARGET_DIR)/usr/bin/chfn
	$(INSTALL) -m 0755 -D $(@D)/src/chsh $(TARGET_DIR)/usr/bin/chsh
	$(INSTALL) -m 0755 -D $(@D)/src/newgrp $(TARGET_DIR)/usr/bin/newgrp
	$(INSTALL) -m 0755 -D $(@D)/src/su $(TARGET_DIR)/bin/su
	$(INSTALL) -m 0755 -D $(@D)/src/login $(TARGET_DIR)/bin/login
endef
